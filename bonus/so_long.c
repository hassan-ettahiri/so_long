...
{
        mlx_destroy_image(va->mlx, va->img->coin);
        mlx_destroy_image(va->mlx, va->img->free_space);
        mlx_destroy_image(va->mlx, va->img->left_pacman);
        mlx_destroy_image(va->mlx, va->img->right_pacman);
        mlx_destroy_image(va->mlx, va->img->up_pacman);
        mlx_destroy_image(va->mlx, va->img->down_pacman);
        mlx_destroy_image(va->mlx, va->img->exit);
        mlx_destroy_image(va->mlx, va->img->wall);
}


void exit_game(t_vars *va)
{
    destroy_images(va);
